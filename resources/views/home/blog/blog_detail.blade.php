                    ...
                    <div class="breadcrumb-menu-wrap">
                        <div class="breadcrumb-menu">
                            <ul>
                                ...
                                <li aria-current="page">{{ __('Blog Details') }}</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="lonyo-blog-d-wrap">
                        ...
                        <!-- Blog Details Live a Comment Box -->
                            ...
                            @foreach ($recentPosts as $item)
                                <a class="lonyo-blog-recent-post-item" href="{{ url('blog/details/' . $item->post_slug) }}">
                                    ...
                                    <div class="lonyo-blog-recent-post-data">
                                        <ul>
                                            <li><img src="{{ asset('frontend/assets/images/blog/date.svg') }}" alt="">{{ $item->created_at->format('d M Y') }}</li>
                                        </ul>
                                        <div>
