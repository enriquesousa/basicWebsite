        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="lonyo-default-content lonyo-cta-wrap" data-aos="fade-up" data-aos-duration="700">
                    ...
                    <!-- Title -->
                    <h2 class="editable-title" contenteditable="{{ auth()->check() ? 'true' : 'false' }}" data-id="{{ $apps->id }}">{{ __($apps->title) }}</h2>
                    
                    <!-- Description -->
                    <p class="editable-description" contenteditable="{{ auth()->check() ? 'true' : 'false' }}" data-id="{{ $apps->id }}">{{ __($apps->description) }}</p>
