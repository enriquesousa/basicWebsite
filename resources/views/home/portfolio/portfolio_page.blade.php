        ...
        <div class="container">
            ...
            <div class="lonyo-portfolio-menu lonyo-section-title" data-aos="fade-up" data-aos-duration="500">
                <ul id="watch-filter-gallery" class="option-set clear-both" data-option-key="filter">
                    ...
                    <li class="wow fadeInUpX" data-wow-delay="0.2s" data-option-value=".development">Development</li>
                    <li class="wow fadeInUpX" data-wow-delay="0.3s" data-option-value=".consultancy">Consultancy</li>
                    <li class="wow fadeInUpX" data-wow-delay="0.4s" data-option-value=".security">Security</li>
                </ul>
            </div>

            <div class="lonyo-portfolio-column" id="lonyo-portfolio-grid">

                <div class="collection-grid-item business">
                    <div class="lonyo-p-thumb" data-aos="fade-up" data-aos-duration="700">
                        <img class="w100" src="{{ asset('frontend/assets/images/portfolio/p3.png') }}" alt="">
                ...
                <div class="collection-grid-item development">
                    <div class="lonyo-p-thumb" data-aos="fade-up" data-aos-duration="900">
                        ...
                        <div class="lonyo-p-data-wrap">
                            <div class="lonyo-p-content">
                                <h4>SpendSmart development 1</h4>
                                <ul>
                ...
                <div class="collection-grid-item Security business">
                    <div class="lonyo-p-thumb" data-aos="fade-up" data-aos-duration="700">
                        <img class="w100" src="{{ asset('frontend/assets/images/portfolio/p3.png') }}" alt="">
                        <div class="lonyo-p-data-wrap">
                            <div class="lonyo-p-content">
                    ...
                    <div class="lonyo-p-thumb" data-aos="fade-up" data-aos-duration="900">
                        ...
                        <div class="lonyo-p-data-wrap">
                            <div class="lonyo-p-content">
                                <h4>Consultancy 1</h4>
                                <ul>
                                    <li><a href="single-portfolio.html">consultancy 1</a></li>
                                    <li><a href="single-portfolio.html">Finance</a></li>
                                </ul>
                            </div>
                            <div class="lonyo-p-title-btn">
                    ...
                    <div class="lonyo-p-thumb" data-aos="fade-up" data-aos-duration="900">
                        ...
                        <div class="lonyo-p-data-wrap">
                            <div class="lonyo-p-content">
                                <h4>Consultancy 2</h4>
                                <ul>
                                    <li><a href="single-portfolio.html">consultancy</a></li>
                                    <li><a href="single-portfolio.html">Finance</a></li>
                                </ul>
                            </div>
                            <div class="lonyo-p-title-btn">
                ...
                <div class="collection-grid-item development security">
                    <div class="lonyo-p-thumb" data-aos="fade-up" data-aos-duration="700">
                        ...
                        <div class="lonyo-p-data-wrap">
                            <div class="lonyo-p-content">
                                <h4>DebtFreePath development 2</h4>
                                <ul>
                                    <li>Creative</li>
                                    <li>App</li>
                                </ul>
                ...
                <div class="collection-grid-item development security">
                    <div class="lonyo-p-thumb" data-aos="fade-up" data-aos-duration="700">
                        ...
                        <div class="lonyo-p-data-wrap">
                            <div class="lonyo-p-content">
                                <h4>DebtFreePath development 3</h4>
                                <ul>
                                    <li>Creative</li>
                                    <li>App</li>
                                </ul>
                ...
                <div class="collection-grid-item">
                    <div class="lonyo-p-thumb mb-0" data-aos="fade-up" data-aos-duration="900">
                        <img class="w100" src="{{ asset('frontend/assets/images/portfolio/p3.png') }}" alt="">
                        <div class="lonyo-p-data-wrap">
                            <div class="lonyo-p-content">
                                <h4> General</h4>
                                <ul>
                                    <li><a href="single-portfolio.html">consultancy 2</a></li>
                                    <li><a href="single-portfolio.html">Finance</a></li>
                                </ul>
                            </div>
                            <div class="lonyo-p-title-btn">
