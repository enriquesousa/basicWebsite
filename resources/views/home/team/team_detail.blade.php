            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="lonyo-team-d-thumb" data-aos="fade-up" data-aos-duration="700">
                        <img src="{{ asset($teamDetail->image) }}" style="width: 526px; height: 550px;" alt="">
                    </div>
                </div>
                <div class="col-lg-7 d-flex align-items-center">
                    <div class="lonyo-default-content pl-50" data-aos="fade-up" data-aos-duration="900">
                        ...
                        {{-- Tengo que crear un modelo para almacenar la imagen,la description, los socials links, le voy a llamar MemberDetails --}}
                        
                        <p>As the Chief Executive Officer of Lonyo, Michael Chen brings over a decade of leadership and
                            expertise in finance and technology. </p>
                        <p>With a passion for innovation, he has been instrumental in shaping the company’s vision to
                            empower individuals and businesses with smarter financial solutions. Under his guidance, Lonyo
                            has grown into a trusted name in the finance software industry, known for its user-centric
                            design, cutting-edge technology. </p>
                        <p class="mb-0">Michael's strategic approach and dedication to fostering a culture of excellence
                            have been key to the company's success. Michael enjoys mentoring young entrepreneurs and staying
                            updated on the latest fintech trends to keep Lonyo ahead of the curve.</p>
