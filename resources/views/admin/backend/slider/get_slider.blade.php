        ...
        <div class="container-xxl">
            ...
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">{{ __('Edit Hero') }}</h4>
                </div>
            </div>
                                            ...
                                            <div class="card border mb-0">
                                                ...
                                                <div class="card-header">
                                                    <div class="row align-items-center">
                                                        <div class="col">
                                                            <h4 class="card-title mb-0">{{ __('Edit Hero') }}</h4>
                                                        </div><!--end col-->
                                                    </div>
                                                </div>
                                                ...
                                                <form action="{{ route('update.review') }}" method="post"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group mb-3 row">
                                                            ...
                                                            <div class="col-lg-12 col-xl-12">
                                                                <img id="showImage" src="{{ !empty($slider->image) ? asset($slider->image) : asset('upload/no_image.jpg') }}" class="rounded-circle avatar-xxl img-thumbnail float-start" alt="image profile">
                                                            </div>
                                                        </div>
