        ...
        <div class="container-xxl">
            ...
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">{{ __('Edit Video Section') }}</h4>
                </div>
            </div>
                                            ...
                                            <div class="card border mb-0">
                                                ...
                                                <div class="card-header">
                                                    <div class="row align-items-center">
                                                        <div class="col">
                                                            <h4 class="card-title mb-0">{{ __('Edit Video Section') }}</h4>
                                                        </div><!--end col-->
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <!-- Download App Link -->
                                                                <div class="form-group mb-3 row">
                                                                    <label class="form-label">{{ __('Download App Link') }}</label>
                                                                    <div class="col-lg-12 col-xl-12">
                                                        ...
                                                        <div class="form-group mb-3 row">
                                                            ...
                                                            <div class="col-lg-12 col-xl-12">
                                                                <img id="showImage" src="{{ !empty($video->image) ? asset($video->image) : asset('upload/no_image.jpg') }}" class="rounded-circle avatar-xxl img-thumbnail float-start" alt="image profile">
                                                            </div>
                                                        </div>
