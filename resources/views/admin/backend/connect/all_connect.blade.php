                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h5 class="card-title mb-0">{{ __('All Connect') }}</h5>
                        </div><!-- end card header -->
                                ...
                                <tbody>
                                    @foreach ($connect as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('edit.connect', $item->id) }}" class="btn btn-success btn-sm" title="{{ __('Edit') }}">{{ __('Edit') }}</a>
                                                <a href="{{ route('delete.connect', $item->id) }}" class="btn btn-danger btn-sm" id="delete" title="{{ __('Delete') }}">{{ __('Delete') }}</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
