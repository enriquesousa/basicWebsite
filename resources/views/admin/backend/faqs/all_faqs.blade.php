                                ...
                                <tbody>
                                    @foreach ($features as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('edit.faq', $item->id) }}" class="btn btn-success btn-sm" title="{{ __('Edit') }}">{{ __('Edit') }}</a>
                                                <a href="{{ route('delete.faq', $item->id) }}" class="btn btn-danger btn-sm" id="delete" title="{{ __('Delete') }}">{{ __('Delete') }}</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
