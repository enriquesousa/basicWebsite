        ...
        <div class="container-xxl">
            ...
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">{{ __('Edit Blog Post') }}</h4>
                </div>
            </div>
                                        ...
                                        <div class="col-lg-12 col-xl-12">
                                            <div class="card border mb-0">
                                                ...
                                                <div class="card-header">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <h5 class="card-title mb-0">{{ __('Edit Blog Post') }}</h5>
                                                        </div>
                                                        <div class="col-md-4">
                                                        ...
                                                        <div class="row mb-3">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="blog_category_id" class="form-control form-select @error('blog_category_id') is-invalid @enderror" id="example-select">
                                                                        ...
                                                                        @foreach ($blogCategories as $item) 
                                                                            <option  @selected($blogPost->blog_category_id == $item->id) value="{{ $item->id }}">{{ $item->category_name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                            ...
                                                            <div class="col-md-8">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control @error('post_title') is-invalid @enderror" type="text" name="post_title" value="{{ $blogPost->post_title }}">
                                                                    @error('post_title')
                                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                                    @enderror
                                                                </div>
                                                        ...
                                                        <div class="row mb-3">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-12 col-xl-12">
                                                                        <input class="form-control @error('image') is-invalid @enderror" type="file" name="image" id="image" value="{{ $blogPost->image }}">
                                                                        @error('image')
                                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                                        @enderror
                                                                    </div>
                                                            ...
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-12 col-xl-12">
                                                                        <img id="showImage" src="{{ asset($blogPost->image) }}" class="avatar-xxl img-thumbnail float-start" alt="image profile" style="width: 50%; height: 50%;">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
